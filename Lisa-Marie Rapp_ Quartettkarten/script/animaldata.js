const data = [
  ...
  },
  {
    ...
    "trivia_german": "Versteckt sich oft in Bananenstauden, wird deshalb auch Bananenspinne genannt",
  ...
  },
  {
      ...
      "id": 33,
      "name_german": "Zebra",
      "trivia_german": "Ein gestreiftes Pferdetier, welches tatsächlich schwarz mit weißen Streifen ist.",
      "trivia": "A striped horse animal that is actually black with white stripes.",
      "group": "G",
      "groupname_german": "Landsäugetiere",
      "groupname": "Land Mammals",
      "group_number": 1,
  ...
  },
{
    ...
    "id": 34,
    "name_german": "Kapuzineraffe",
    "trivia_german": "Ein schlauer Affe, der Werkzeuge nutzen kann.",
    "trivia": "A clever monkey known for tool use and frequent appearances in movies.",
    "group": "G",
    "groupname_german": "Landsäugetiere",
    "groupname": "Land Mammals",
    "group_number": 1,
...
},
{
  "id": 5,
  "name_german": "Leopard",
  "trivia_german": "Ein geschickter Jäger, bekannt für seine Fähigkeit, Bäume zu erklimmen und seine Beute hoch in die Äste zu ziehen.",
  "trivia": "A skilled hunter known for its ability to climb trees and stash prey in high branches.",
  "group": "A",
  "groupname_german": "Raubtiere",
  "groupname": "Predators",
  "group_number": 3,
...
},
{
  "id": 40,
  "name_german": "Panda",
  "trivia_german": "Ein Bär, der für seine Vorliebe für Bambus bekannt ist.",
  "trivia": "A bear known for its distinctive black-and-white fur and preference for bamboo.",
  "group": "I",
...
{
  "id": 41,
  "name_german": "Faultier",
  "trivia_german": "Das langsamste landlebende Tier der Welt, das fast sein ganzes Leben in Bäumen verbringt.",
  "trivia": "The slowest land mammal in the world, spending most of its life in trees.",
  "group": "I",
  "groupname_german": "Säugetiere",
  "groupname": "Mammals",
  "group_number": 1,
...
},
{
  "id": 42,
  "name_german": "Koala",
  "trivia_german": "Ein Beuteltier, das Eukalyptusblätter und seinen gemütlichen Lebensstil liebt.",
  "trivia": "A marsupial known for its preference for eucalyptus leaves and its relaxed lifestyle.",
  "group": "I",
  "groupname_german": "Säugetiere",
  "groupname": "Mammals",
  "group_number": 1,
...
},
{
  "id": 28,
  "name_german": "Pinguin",
  "trivia_german": "Ein flugunfähiger Vogel, der hervorragend schwimmen kann und in kalten Regionen lebt.",
  "trivia": "A flightless bird that excels at swimming and lives in cold regions.",
  "group": "H",
  "groupname_german": "Vögel",
  "groupname": "Birds",
  "group_number": 1,
  ...
  "max_length": 80,
  "litter_size": 2,
  "continents": "Antarktis, Südamerika, Australien, Neuseeland, Südafrika",
  "intelligence": 4
},
{
    "id": 43,
    "name_german": "Wombat",
    "trivia_german": "Ein unterirdisch lebendes Beuteltier, das für seine Fähigkeit, Tunnel zu graben, bekannt ist.",
    "trivia": "A burrowing marsupial known for its calm demeanor and ability to dig tunnels.",
    "group": "I",
    "groupname_german": "Säugetiere",
    "groupname": "Mammals",
    "group_number": 1,
